...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8 comment ='测试用户表';
...
(
  ...
  default charset = utf8 comment ='抢购商品库存表';

insert into goods(goods_name, inventory, start_time, end_time)
values ('998抢购iphone8', 1000, '2017-06-05 00:00:00', '2017-06-06 00:00:00'),
